...
public class ImageProcessor {
    ...
    public void deskew(BufferedImage image) {
        resize(image);
    ...
    private void resize(BufferedImage bufferedImage) {
//        Scalr.resize(bufferedImage, Scalr.Method.ULTRA_QUALITY, (int) (bufferedImage.getWidth() * 3.3));
    }
